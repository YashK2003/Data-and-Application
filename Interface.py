...
# def update_and_delete(sql_cur,conn):
#     print("Welcome to SQL Query Mode : ")
...
def insert(sql_cur,conn):
    ...
    # tgempage = today_date.year - birthdate.year - ((today.month, today.day) < (birthdate.month, birthdate.day))
    # return tgempage
    head = []
    # ct=0
    # print("First Enter DOB AND AGE IN RECORDS : ")
    # dob = input("Enter DOB : ")
    # print(age)
    # print(dob)
    # querytemp = "INSERT INTO age_from_dob (DOB,Age) VALUES (%s,%s)"
    # sql_cur.execute(querytemp, (dob,age));
    # conn.commit()
